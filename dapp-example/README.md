...
A minimal Next.js application demonstrating all features of the [AVNU SDK](https://github.com/avnu-labs/avnu-sdk) for Starknet.

📚 **Documentation**: [docs.avnu.fi](https://docs.avnu.fi)
