...
import { z } from 'zod';
import { BASE_URL, IMPULSE_BASE_URL, PAYMASTER_BASE_URL } from './constants';
...
export const getPaymasterBaseUrl = (options?: AvnuOptions): string => options?.paymasterBaseUrl ?? PAYMASTER_BASE_URL;
